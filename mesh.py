...
def Mesh(ox=0.,lx=1.,nx=1,offset=1,order=1,type='uniform',
         nodes=None,vertices=None,elements=None,connect=None,
         dimension=None,file=None,string=None,block=None):
    '''
    Mesh factor method. Interfaces with the FiniteElementMesh class
    :param ox:
    :param lx:
    :param nx:
    :param offset:
...
class FiniteElementMesh(object):
    ...
    def element_index(self, elements):
        ...
        :param elements: array_like or int
            Element labels
    ...
    def connectivity(self, elements=None):
        ...
        :param elements: array_like of int [None]
            List of elements
        :return:
        conn: ndarray of int
    ...
    def elems_per_block(self):
        ...
        Note:
            Elements are stored contiguously by block.
            Using this function, the elements in a block
            can be isolated.
        '''
    ...
    def coordinates(self, nodes=None):
        ...
        :param nodes: array_like of int [None]
            List of nodes
        :return:
    ...
    def extend(self,dx,nx,block=None,order=1):
        ...
        ox = self.boundary[-1]
        o  = max(self.nodes)
        nodes, vertices, elements, connect = genmesh_1d(ox, dx, nx,
                                                        offset=o,order=order)
    ...
    def get_node_labes(self, nodes, nodeset, region):
    ...
    def ElementBlock(self, name=None, elements=None):
        ...
        if name is None:
            ...
            while True:
                ...
                i += 1
                if i > MAX_NUM_SETS:
                    raise ValueError('maximun number of blocks exceeded')
        ...
        try:
            ...
            raise ValueError('cannot assign elements of different order to block {0}'.format(name))
